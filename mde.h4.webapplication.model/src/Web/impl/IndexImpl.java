 ...
 * </p>
 * <ul>
 *   <li>{@link Web.impl.IndexImpl#getEntity <em>Entity</em>}</li>
...
public class IndexImpl extends NamedElementImpl implements Index {
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebPackage.INDEX__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(Entity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebPackage.INDEX__ENTITY, oldEntity, entity));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == DContent.class) {
			switch (derivedFeatureID) {
				case WebPackage.INDEX__ENTITY: return WebPackage.DCONTENT__ENTITY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == DContent.class) {
			switch (baseFeatureID) {
				case WebPackage.DCONTENT__ENTITY: return WebPackage.INDEX__ENTITY;
				default: return -1;
			}
		}
